...
const T = [
  { te: { "నాకు": "naaku", "సంతోషంగా": "santhoshamga", "ఉంది": "undi" },
    ta: { "எனக்கு": "enakku", "சந்தோஷமாக": "santhoshamaaga", "இருக்கிறது": "irukkiradhu" },
  ...
  { te: { "మనకి": "manaki", "ఆట": "aata", "ఇష్టం": "ishtam" },
    ta: { "நமக்கு": "namakku", "விளையாட்டு": "vilaiyaattu", "பிடிக்கும்": "pidikkum" },
    es: { "Nos": "nohs", "gusta": "goos-tah", "jugar": "hoo-gar" } },
  { te: { "వాళ్ళకి": "vaallaki", "అన్నం": "annam", "కావాలి": "kaavaali" },
    ta: { "அவர்களுக்கு": "avargalukku", "சாப்பாடு": "saappaadu", "வேண்டும்": "vendum" },
  ...
  { te: { "అమ్మకి": "ammaki", "పువ్వు": "puvvu", "ఇచ్చాను": "ichchaanu" },
    ...
    es: { "Le": "leh", "di": "dee", "una": "oo-nah", "flor": "flor", "a": "ah", "mamá": "mah-mah" } },
  ...
  { te: { "తనకి": "thanaki", "బొమ్మ": "bomma", "కావాలి": "kaavaali" },
    ...
    es: { "Ella": "eh-yah", "quiere": "kee-eh-reh", "un": "oon", "juguete": "hoo-geh-teh" } },
  ...
  { te: { "ఆమె": "aame", "నా": "naa", "అక్క": "akka" },
    ...
    es: { "Ella": "eh-yah", "es": "es", "mi": "mee", "hermana": "er-mah-nah", "mayor": "mah-yor" } },
];
