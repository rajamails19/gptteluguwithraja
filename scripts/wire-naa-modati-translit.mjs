...
const T = [
  ...
  { te: { "నేను": "nenu", "USA": "USA", "లో": "lo", "ఉంటాను": "untaanu" },
    ta: { "நான்": "naan", "அமெரிக்காவில்": "amerikkaavil", "வசிக்கிறேன்": "vasikkiren" },
    es: { "Vivo": "vee-voh", "en": "en", "Estados": "es-tah-dohs", "Unidos": "oo-nee-dohs" } },
  { te: { "నాకు": "naaku", "అన్నం-పప్పు": "annam-pappu", "అంటే": "ante", "చాలా": "chaalaa", "ఇష్టం": "ishtam" },
    ta: { "எனக்கு": "enakku", "சோறு-பருப்பு": "soru-paruppu", "என்றால்": "endraal", "மிகவும்": "migavum", "பிடிக்கும்": "pidikkum" },
    es: { "Me": "meh", "encanta": "en-kan-tah", "el": "el", "arroz": "ah-rohs", "con": "kohn", "dal": "dahl" } },
  { te: { "మా": "maa", "అమ్మ": "amma", "పేరు": "peru", "రాణి": "raani" },
    ta: { "என்": "en", "அம்மா": "amma", "பெயர்": "peyar", "ராணி": "raani" },
    es: { "Mi": "mee", "mamá": "mah-mah", "se": "seh", "llama": "yah-mah", "Rani": "rah-nee" } },
  { te: { "నేను": "nenu", "తెలుగు": "telugu", "నేర్చుకుంటున్నాను": "nerchukuntunnaanu" },
    ta: { "நான்": "naan", "தமிழ்": "tamizh", "கற்றுக்கொள்கிறேன்": "katrukkolgiren" },
    es: { "Estoy": "es-toy", "aprendiendo": "ah-pren-dee-en-doh", "español": "es-pah-nyol" } },
  { te: { "నా": "naa", "చెల్లి": "chelli", "పేరు": "peru", "క్యూటీ": "cutie" },
    ta: { "என்": "en", "தங்கை": "thangai", "பெயர்": "peyar", "க்யூட்டி": "cutie" },
    es: { "Mi": "mee", "hermana": "er-mah-nah", "se": "seh", "llama": "yah-mah", "Cutie": "cutie" } },
  { te: { "నా": "naa", "అన్న": "anna", "పేరు": "peru", "పండు": "pandu" },
    ta: { "என்": "en", "அண்ணன்": "annan", "பெயர்": "peyar", "பண்டு": "pandu" },
    es: { "Mi": "mee", "hermano": "er-mah-noh", "se": "seh", "llama": "yah-mah", "Pandu": "pandu" } },
];
