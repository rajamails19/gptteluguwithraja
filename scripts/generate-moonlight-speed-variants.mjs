...
const taraVoiceId = process.env.ELEVENLABS_VOICE_TARA || env.ELEVENLABS_VOICE_TARA;

if (!apiKey) throw new Error("Missing ELEVENLABS_API_KEY in environment or .env");
if (!taraVoiceId) throw new Error("Missing ELEVENLABS_VOICE_TARA in environment or .env");
...
const handcrafted = [
  ...
  {
    "005": "చందమామ. ... . ... రావే. ... . ... జాబిల్లి. ... . ... రావే. ... . ... మా. ... . ... ఇంటికి. ... . ... వెలుగు. ... . ... తెచ్చావే.",
    "015": "చందమామ. ... రావే. ... జాబిల్లి. ... రావే. ... మా. ... ఇంటికి. ... వెలుగు. ... తెచ్చావే.",
  ...
  {
    "005": "కొండెక్కి. ... . ... రావే. ... . ... కోటి. ... . ... పూలు. ... . ... తీసుకు. ... . ... వచ్చావే.",
  ...
  {
    "005": "బంగారు. ... . ... పళ్లెంలో. ... . ... మెల్లగా. ... . ... పాలు. ... . ... పోసావే.",
  ...
  {
    "005": "నా. ... . ... బాబుకు. ... . ... హాయిగా. ... . ... నిద్ర. ... . ... పుచ్చావే.",
...
for (const variant of variants) {
  for (let index = 0; index < handcrafted.length; index++) {
    ...
    const response = await fetch(`https://api.elevenlabs.io/v1/text-to-speech/${taraVoiceId}`, {
      method: "POST",
      headers: {
        "xi-api-key": apiKey,
    ...
    console.log(`✓ moonlight-rhymes page ${pageNumber} ${variant.label} (Tara)`);
  }
}
