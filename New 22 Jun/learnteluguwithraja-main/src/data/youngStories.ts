    ...
    chapters: [
      {
        ...
        english: "Meera, a curious girl, finally steps into the forest she has watched for years.",
        image: forest1,
      },
      {
        title: "వెలుగు లేడి",
        ...
        english: "A glowing deer speaks and asks Meera to follow it deeper into the forest.",
        image: forest2,
      },
      {
        title: "దీపాల చెట్టు",
    ...
    chapters: [
      {
        ...
        english: "Ravi watches the night sky from his rooftop, dreaming of touching the stars.",
        image: stars1,
      },
      {
        ...
        english: "A small star falls into Ravi's hands. It tells him it has lost its way home.",
        image: stars2,
      },
      {
