...
function YoungReadersPage() {
  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden border-b border-border/60 bg-gradient-to-br from-purple-100/60 via-pink-100/50 to-amber-100/60 py-16 sm:py-24">
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center sm:px-8">
          ...
          <motion.h1
            ...
            className="mt-5 font-display text-4xl tracking-tight text-foreground sm:text-6xl"
          >
            Young Readers
          </motion.h1>
          <motion.p
            ...
            className="mt-4 font-telugu text-xl leading-relaxed text-foreground/80 sm:text-2xl"
          >
      ...
      <main className="mx-auto max-w-7xl px-5 py-12 sm:px-8 sm:py-16">
        ...
        <p className="mt-12 text-center font-telugu text-sm text-foreground/50">
          మరిన్ని కథలు త్వరలో…
        </p>
      </main>
